...
CombinedDiscoba <- CombinedDiscoba %>% left_join(select(TaxonomyDiscoba, `Class name`,`Order name`, `Genus name`, Organism_Taxonomic_ID), by=c("Organism_Taxonomic_ID"))
CombinedMetamonada <- CombinedMetamonada %>% left_join(select(TaxonomyMetamonada, `Class name`,`Order name`, `Genus name`, Organism_Taxonomic_ID), by=c("Organism_Taxonomic_ID"))
