...
```{r}
RICTORExcavata <- merge(RICTORExcavata, Excavata_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
RAPTORExcavata <- merge(RAPTORExcavata, Excavata_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
SIN1Excavata <- merge(SIN1Excavata, Excavata_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
LST8Excavata <- merge(LST8Excavata, Excavata_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
TORExcavata <- merge(TORExcavata, Excavata_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
```
