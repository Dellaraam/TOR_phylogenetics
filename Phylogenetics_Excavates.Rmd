...
CombinedDiscoba <- merge(CombinedDiscoba, Discoba_Busco[c("C.score","Frag.score", "Accn")], by = "Accn")
...
CombinedMetamonada <- merge(CombinedMetamonada, Metamonada_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
