...
mainCombine <- function(Grouping, Namedf, RICTORdf, SIN1df, RAPTORdf, LST8df, TORdf, D1df){
  ...
  returnDF <- returnDF %>% add_column(RICTOR = NA, SIN1 = NA, RAPTOR = NA, LST8 = NA, TOR = NA, D1 = NA)
...
CombinedAlveolata <- mainCombine("Alveolata", Alveolata_Names, RICTORAlveolata, SIN1Alveolata, RAPTORAlveolata, LST8Alveolata, TORAlveolata, D1Alveolata)
...
CombinedStramenopiles <- mainCombine("Stramenopile", Stramenopiles_Names, RICTORStramenopiles, SIN1Stramenopiles, RAPTORStramenopiles, LST8Stramenopiles, TORStramenopiles, D1Stramenopiles)
