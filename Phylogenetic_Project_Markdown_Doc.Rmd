...
```{r include=FALSE}
#Rhizaria (Future)
D1Rhizaria <- D1RhizariaRaw %>% filter(sca >= 0 & scd >= 0)
RICTORRhizaria <- RICTORRhizariaRaw %>% filter(sca >= 0 & scd >= 0)
RAPTORRhizaria <- RAPTORRhizariaRaw %>% filter(sca >= 0 & scd >= 0)
SIN1Rhizaria <- SIN1RhizariaRaw %>% filter(sca >= 0 & scd >= 0)
LST8Rhizaria <- LST8RhizariaRaw %>% filter(sca >= 0 & scd >= 0)
TORRhizaria <- TORRhizariaRaw %>% filter(sca >= 0 & scd >= 0)
```
