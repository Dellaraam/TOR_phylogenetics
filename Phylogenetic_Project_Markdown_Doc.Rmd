...
```{r}
D1RhizariaPlot <- ggplot(D1Rhizaria, aes(x = sca, y = scd, color = C.score, label = Organism.Name))+
  geom_point()+
  geom_text_repel(direction = "y",
                  min.segment.length = 0.5,
                  force = 10,
...
RICTORRhizariaPlot <- ggplot(RICTORRhizaria, aes(x = sca, y = scd, color = C.score, label = Organism.Name))+
  geom_point()+
  geom_text_repel(direction = "y",
                  min.segment.length = 0.5,
                  force = 10,
...
SIN1RhizariaPlot <- ggplot(SIN1Rhizaria, aes(x = sca, y = scd, color = C.score, label = Organism.Name))+
  geom_point()+
  geom_text_repel(direction = "y",
                  min.segment.length = 0.5,
                  force = 10,
...
RAPTORRhizariaPlot <- ggplot(RAPTORRhizaria, aes(x = sca, y = scd, color = C.score, label = Organism.Name))+
  geom_point()+
  geom_text_repel(direction = "y",
                  min.segment.length = 0.5,
                  force = 10,
...
LST8RhizariaPlot <- ggplot(LST8Rhizaria, aes(x = sca, y = scd, color = C.score, label = Organism.Name))+
  geom_point()+
  geom_text_repel(direction = "y",
                  min.segment.length = 0.5,
                  force = 10,
...
TORRhizariaPlot <- ggplot(TORRhizaria, aes(x = sca, y = scd, color = C.score, label = Organism.Name))+
  geom_point()+
  geom_text_repel(direction = "y",
                  min.segment.length = 0.5,
                  force = 10,
