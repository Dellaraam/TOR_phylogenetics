...
D1AlveolataRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Alveolata/D1Alveolata.csv")
RAPTORAlveolataRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Alveolata/RAPTORAlveolata.csv")
RICTORAlveolataRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Alveolata/RICTORAlveolata.csv")
SIN1AlveolataRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Alveolata/SIN1Alveolata.csv")
TORAlveolataRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Alveolata/TORAlveolata.csv")
LST8AlveolataRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Alveolata/LST8Alveolata.csv")

D1StramenopilesRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Stramenopiles/D1Stramenopiles.csv")
RAPTORStramenopilesRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Stramenopiles/RAPTORStramenopiles.csv")
RICTORStramenopilesRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Stramenopiles/RICTORStramenopiles.csv")
SIN1StramenopilesRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Stramenopiles/SIN1Stramenopiles.csv")
TORStramenopilesRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Stramenopiles/TORStramenopiles.csv")
LST8StramenopilesRaw <- read.csv("C:/Users/kajoh/Desktop/Tables/Updated_Stramenopiles/LST8Stramenopiles.csv")
```
...
Alveolata_Busco <- read.csv("C:/Users/kajoh/Desktop/Tables/Alveolata BUSCO - Sheet1.csv", na = 0)
...
Stramenopiles_Busco <- read.csv("C:/Users/kajoh/Desktop/Tables/Stramenopiles BUSCO - Sheet1.csv")
...
BuscoAdd <- function(inputCSV, BUSCO){
  ...
  if ("C_score" %in% colnames(inputCSV) & "Fragmentation" %in% colnames(inputCSV)){
    ...
    inputCSV <- inputCSV %>% add_column(C_score = 0, .after = "bid")
    inputCSV <- inputCSV %>% add_column(Fragmentation = 0, .after = "C_score")
  }
