...
RictorDataPlot <- left_join(RictorData, select(CombinedProject, `Super Group`, Accn), by=c("Accn"))
SIN1DataPlot <- left_join(SIN1Data, select(CombinedProject, `Super Group`, Accn), by=c("Accn"))
RAPTORDataPlot <- left_join(RAPTORData, select(CombinedProject, `Super Group`, Accn), by=c("Accn"))
TORDataPlot <- left_join(CData, select(CombinedProject, `Super Group`, Accn), by=c("Accn"))
LST8DataPlot <- left_join(LST8Data, select(CombinedProject, `Super Group`, Accn), by=c("Accn"))
```
...
## RICTOR Values Plots
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(RictorDataPlot,aes(`Super Group`, fill = `Super Group`))+
  geom_bar()+
  scale_fill_brewer(palette = "Dark2")+
  theme_light()+
...
## RICTOR Values Plots
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(RictorDataPlot,aes(`Phylum name`, fill = `Super Group`))+
  geom_bar()+
  scale_fill_brewer(palette = "Dark2")+
  theme_light()+
  theme(axis.text.x = element_text(angle = 90))+ 
...
## SIN1 Relative Plot
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(SIN1DataPlot,aes(`Super Group`, fill = `Super Group`))+
...
## SIN1 Relative Plot 2
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(SIN1DataPlot,aes(`Phylum name`, fill = `Super Group`))+
  geom_bar(show.legend = FALSE)+
  scale_fill_brewer(palette = "Dark2")+
  theme_light()+
  theme(axis.text.x = element_text(angle = 90))+ 
...
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(RAPTORDataPlot,aes(`Super Group`, fill = `Super Group`))+
  geom_bar(show.legend = FALSE)+
  scale_fill_brewer(palette = "Dark2")+
  theme_light()+
  theme(axis.text.x = element_text(angle = 90))+
...
## RAPTOR Values Plots
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(RAPTORDataPlot,aes(`Phylum name`, fill = `Super Group`))+
  geom_bar(show.legend = FALSE)+
  scale_fill_brewer(palette = "Dark2")+
  theme_light()+
  theme(axis.text.x = element_text(angle = 90))+ 
...
## Slide
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(TORDataPlot,aes(`Super Group`, fill = `Super Group`))+
  geom_bar(show.legend = FALSE)+
  scale_fill_brewer(palette = "Dark2")+
  theme_light()+
  theme(axis.text.x = element_text(angle = 90))+
...
## Slide
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(TORDataPlot,aes(`Phylum name`, fill = `Super Group`))+
  geom_bar(show.legend = FALSE)+
  scale_fill_brewer(palette = "Dark2")+
  theme_light()+
  theme(axis.text.x = element_text(angle = 90))+ 
...
## Slide
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(LST8DataPlot,aes(`Super Group`, fill = `Super Group`))+
  geom_bar(show.legend = FALSE)+
  scale_fill_brewer(palette = "Dark2")+
  theme_light()+
  theme(axis.text.x = element_text(angle = 90))+ 
...
## Slide
```{r, fig.width=10, fig.height=10, dpi=400, out.height="150%", out.width="150%"}
ggplot(LST8DataPlot,aes(`Phylum name`, fill = `Super Group`))+
  geom_bar(show.legend = FALSE)+
  scale_fill_brewer(palette = "Dark2")+
  theme_light()+
  theme(axis.text.x = element_text(angle = 90))+ 
