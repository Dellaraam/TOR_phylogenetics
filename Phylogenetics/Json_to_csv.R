...
JsontoCSV("~/GitHub/TOR_phylogenetics/GitHub_CSV/Streptophyta_Jsons/", "~/GitHub/TOR_phylogenetics/GitHub_CSV/StreptophytaBusco.csv")
JsontoCSV("~/GitHub/TOR_phylogenetics/GitHub_CSV/Excavata_Jsons", "~/GitHub/TOR_phylogenetics/GitHub_CSV/ExcavataJGIBusco.csv")
JsontoCSV("~/GitHub/TOR_phylogenetics/GitHub_CSV/Heterokonta_Jsons", "~/GitHub/TOR_phylogenetics/GitHub_CSV/HeterokontaJGIBusco.csv")
JsontoCSV("~/GitHub/TOR_phylogenetics/GitHub_CSV/Chlorophyta_Jsons", "~/GitHub/TOR_phylogenetics/GitHub_CSV/ChlorophytaJGIBusco.csv")
JsontoCSV("~/GitHub/TOR_phylogenetics/GitHub_CSV/Rhizaria_Jsons", "~/GitHub/TOR_phylogenetics/GitHub_CSV/RhizariaJGIBusco.csv" )
JsontoCSV("~/GitHub/TOR_phylogenetics/GitHub_CSV/Alveolata_Jsons", "~/GitHub/TOR_phylogenetics/GitHub_CSV/AlveolataJGIBusco.csv")
