...
```{r}
# Streptophyta
Klebsormidiophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Streptophyta/Klebsormidiophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
Streptophytina <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Streptophyta/Streptophytina_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")

# Chlorophyta
Chlorophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Chlorophyta/Chlorophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
Chloropicophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Chlorophyta/Chloropicophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
Mamielleophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Chlorophyta/Mamielleophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
Pedinophyceae <-read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Chlorophyta/Pedinophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
Pyramimonadophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Chlorophyta/Pyramimonadophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
Trebouxiophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Chlorophyta/Trebouxiophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
Ulvophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Chlorophyta/Ulvophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")

# Rhodophyta
Bangiophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Rhodophyta/Bangiophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
Florideophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Rhodophyta/Florideophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
Stylonematophyceae <- read_tsv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Updated_Rhodophyta/Stylonematophyceae_Information.tsv", show_col_types = FALSE) %>% rename(Accn = "Assembly Accession") %>% rename(Organism_Taxonomic_ID = "Organism Taxonomic ID") %>% rename(Organism_Name = "Organism Name")
...
CombinedStreptophyta <- CombinedStreptophyta %>% left_join(select(FullTaxonomyStreptophyta, `Class name`,`Order name`, `Genus name`, Organism_Taxonomic_ID), by=c("Organism_Taxonomic_ID"))
CombinedRhodophyta <- CombinedRhodophyta %>% left_join(select(FullTaxonomyRhodophyta, `Class name`,`Order name`, `Genus name`, Organism_Taxonomic_ID), by=c("Organism_Taxonomic_ID"))
CombinedChlorophyta <- CombinedChlorophyta %>% left_join(select(FullTaxonomyChlorophyta, `Class name`,`Order name`, `Genus name`, Organism_Taxonomic_ID), by=c("Organism_Taxonomic_ID"))



# for(i in 1:nrow(CombinedStreptophyta)){
#   for(j in 1:nrow(FullTaxonomy)){
#     if(CombinedStreptophyta[i, "Organism_Taxonomic_ID"] == FullTaxonomy[j, "Organism_Taxonomic_ID"]){
#       CombinedStreptophyta$Class[i] <- FullTaxonomy$`Class name`[j]
#     }
#   }
# }
