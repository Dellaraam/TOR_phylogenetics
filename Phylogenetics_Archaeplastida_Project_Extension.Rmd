...
D1Chlorophyta <- merge(D1ChlorophytaRaw, ChlorophytaNames[c("Organism_Taxonomic_ID", "Organism_Name", "Accn")], by ="Accn") %>% merge(Chlorophtyta_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
LST8Chlorophyta <- merge(LST8ChlorophytaRaw, ChlorophytaNames[c("Organism_Taxonomic_ID", "Organism_Name", "Accn")], by ="Accn") %>% merge(Chlorophtyta_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
RAPTORChlorophyta <- merge(RAPTORChlorophytaRaw, ChlorophytaNames[c("Organism_Taxonomic_ID", "Organism_Name", "Accn")], by ="Accn") %>% merge(Chlorophtyta_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
RICTORChlorophyta <- merge(RICTORChlorophytaRaw, ChlorophytaNames[c("Organism_Taxonomic_ID", "Organism_Name", "Accn")], by ="Accn") %>% merge(Chlorophtyta_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
SIN1Chlorophyta <- merge(SIN1ChlorophytaRaw, ChlorophytaNames[c("Organism_Taxonomic_ID", "Organism_Name", "Accn")], by ="Accn") %>% merge(Chlorophtyta_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
TORChlorophyta <- merge(TORChlorophytaRaw, ChlorophytaNames[c("Organism_Taxonomic_ID", "Organism_Name", "Accn")], by ="Accn") %>% merge(Chlorophtyta_Busco[c("C.score","Frag.score","Accn")], by = "Accn")
