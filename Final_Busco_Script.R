...
AlveolataBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Alveolata_BUSCO_Sheet1.csv")
...
AlveolataJGIBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/AlveolataJGIBusco.csv")
...
StramenopileBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Stramenopiles BUSCO - Sheet1.csv")
...
StramenopileJGIBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/HeterokontaJGIBusco.csv")
...
RhizariaBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Rhizaria_BUSCO_Sheet1.csv")
...
RhizariaJGIBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/RhizariaJGIBusco.csv")
...
ChlorophytaBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Chlorophyta-BUSCO-Sheet1.csv")
...
ChlorophytaJGIBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/ChlorophytaJGIBusco.csv")
...
RhodophytaBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Rhodophyta-BUSCO-Sheet1.csv")
...
StreptophytaBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/StreptophytaBusco.csv")
StreptophytaBusco <- StreptophytaBusco %>% select(Accn, C.score, Frag.score)
StreptophytaFinalBusco <- StreptophytaBusco

ExcavataBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/Excavata-BUSCO-Sheet1.csv")
...
ExcavataJGIBusco <- read.csv("~/GitHub/TOR_phylogenetics/GitHub_CSV/ExcavataJGIBusco.csv")
...
write.csv(FinalBusco, "~/GitHub/TOR_phylogenetics/GitHub_CSV/FinalBusco.csv")
