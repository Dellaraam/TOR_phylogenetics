...
```{r}
RICTORAlveolataPlot <- ggplot(filter(RictorDataPlot, `Super Group` == "Chlorophyta"), aes(x = sca, y = scd, color = C.score, label = Organism_Name))+
  geom_point()+
  geom_text_repel(data = filter(RictorDataPlot, `Super Group` == "Chlorophyta"),
                  direction = "y",
